...
print(len(planetas)) #Usamos la funci[on leng = length significa largo
...
#Los que podemos usar dentro de tuplas son: index, count, len
...
conjunto1 = frozenset #Esto hace que el cojunto sea totalmente inmutable
...
seleccionArgentina = {
    ...
    13:{'Nombre': "Cristian Romero", 'Edad':24, 'Altura':1.88, 'Precio': '30 Millones', 'Posicion': 'Defensor'},
    17:{'Nombre': "Alejandro Gomez", 'Edad':34, 'Altura':1.67, 'Precio': '5.5 Millones', 'Posicion': 'Delantero'},
    5:{'Nombre': "Leandro Paredes", 'Edad':28, 'Altura':1.80, 'Precio': '7 Millones', 'Posicion': 'Mediocampista'},
